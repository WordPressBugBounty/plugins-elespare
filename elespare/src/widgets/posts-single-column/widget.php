...
class PostSingleColumn extends Widget_Base
{
  ...
  protected function register_controls()
  {
    ...
    $this->posts_list_style_readmore_options();
  }
  ...
  //Read More text
  private function  posts_list_style_readmore_options()
  {
    $this->start_controls_section(
      'section_posts_readmore_style',
      [
        'label' => esc_html__('Read More', 'elespare-pro'),
        'tab'   => Controls_Manager::TAB_STYLE,
        'condition' => [
    ...
    $this->add_group_control(
      ...
      [
        ...
        'selector'  => '{{WRAPPER}} .elespare-single-list-wrap .elespare-posts-wrap .elespare-posts-single-list-post-items  .read-more-btn',
      ]
    );
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          '{{WRAPPER}} .elespare-single-list-wrap .elespare-posts-wrap .elespare-posts-single-list-post-items .read-more-btn' => 'color: {{VALUE}};',
        ]
      ]
    );
