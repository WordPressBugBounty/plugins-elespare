...
if (! function_exists('elespare_posts_grid_render_thumbnail')) {
  function elespare_posts_grid_render_thumbnail($post_thumbnail_size = 'full')
  {
    ...
    if (has_post_thumbnail()) :
      ...
      // Custom alt text or fallback to post title
    ...
    ?>
      ...
      <a href="<?php the_permalink(); ?>" aria-label="<?php echo esc_attr($post_title); ?>">
        <?php
        the_post_thumbnail(
          $post_thumbnail_size,
          array(
...
if (! function_exists('elespare_section_title')) {
  function elespare_section_title($wrapper_attributes = '', $title = '')
  {
    ...
    printf(
      '<div %1$s>
				<h2 class="elespare-widget-title">
					...
					<span class="elespare-section-title">%2$s</span>
					<span class="elespare-section-title-after"></span>
				</h2>
			</div>',
      $wrapper_attributes,
      elespare_kses_basic($title)
    );
  }
}
...
function elespare_posts_render_readmore($show_read_more = '', $read_more_text = '')
{
  ...
  <a class="read-more-btn" href="<?php the_permalink(); ?>">
    ...
    <span class="screen-reader-text"> <?php echo esc_html__('about', 'elespare') ?> <?php the_title(); ?></span>
  </a>
  <?php
}
/**
    ...
    if ($post_categories) {
      ...
      foreach ($post_categories as $post_category) {
        ...
        $output .= '<li class="elespare-meta-category">
          ...
          __('View all posts in %s category', 'elespare'),
          $post_category->name
        )) . '">
